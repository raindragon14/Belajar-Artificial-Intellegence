...
1. **Hierarki:** Memahami bedanya AI, Machine Learning, dan Deep Learning.
2. **Pergeseran Paradigma:** Bagaimana cara kita menyuruh komputer berubah total (dari *Rule-based* ke *Data-driven*).
3. **Intuisi Matematika:** Bahasa yang digunakan AI untuk memahami dunia.
